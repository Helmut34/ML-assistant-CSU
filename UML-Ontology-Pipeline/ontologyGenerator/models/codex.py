"""
Codex Model integration for direct UML to ontology generation.
...
def generate_ontology_with_codex(uml: str, model: str = "gpt-3.5-turbo", api_key: str = None, benchmark: bool = True) -> Union[str, Tuple[str, dict]]:
    """
    Generate an OWL ontology directly from UML XMI using Codex/GPT-3.5.
...
"""
    ...
    try:
        ...
        error_msg = f"Error generating ontology with Codex: {e}"
        print(error_msg)
...
if __name__ == "__main__":
    ...
    print("Generating ontology with Codex...")
    ontology_ttl, metrics = generate_ontology_with_codex(
        uml_xmi,
        model="gpt-3.5-turbo",
        benchmark=True
    )
    ...
    if ontology_ttl:
        with open("../benchmark/codex_ontology.ttl", "w") as f:
            f.write(ontology_ttl)
        print("Ontology saved to ../benchmark/codex_ontology.ttl")

    save_benchmark_results(metrics, "../benchmark/codex_benchmark.json")
